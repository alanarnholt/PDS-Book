...
Please watch the [CHI SQUARE Video](https://www.youtube.com/watch?v=eLAFK_XovnE&index=57&list=PLDEF0B9CBD27AD37E).
...
print(xtable(TX, caption = "Table showing drinking status during the last two hours and gender"), type = "html")
```
...
chisq.test(NT[,1:2], correct = FALSE)
chisq.test(NT[,1:3], correct = FALSE)
chisq.test(NT[,1:4], correct = FALSE)
chisq.test(NT[,1:5], correct = FALSE)
chisq.test(NT[,2:3], correct = FALSE)
chisq.test(NT[,2:4], correct = FALSE)
chisq.test(NT[,2:5], correct = FALSE)
chisq.test(NT[,3:4], correct = FALSE)
chisq.test(NT[,3:5], correct = FALSE)
chisq.test(NT[,4:5], correct = FALSE)
```

#### CHI SQUARE ASSIGNMENT

Post syntax to your private GitHub repo used to run a Chi-Square Test  along with corresponding output and a few sentences of interpretation. 
...
prop.table(T3, 2)
library(ggplot2)
ggplot(data = nesarc, aes(x = DCScat, fill = TobaccoDependence)) + 
  geom_bar(position = "fill") +
  theme_bw() +
  labs(x= "Daily Smoking Frequency", y = "Fraction")
chisq.test(T3, correct = FALSE)
chisq.test(T3[,1:2], correct = FALSE)
chisq.test(T3[,1:3], correct = FALSE)
chisq.test(T3[,1:4], correct = FALSE)
chisq.test(T3[,1:5], correct = FALSE)
chisq.test(T3[,2:3], correct = FALSE)
chisq.test(T3[,2:4], correct = FALSE)
chisq.test(T3[,2:5], correct = FALSE)
chisq.test(T3[,3:4], correct = FALSE)
chisq.test(T3[,3:5], correct = FALSE)
chisq.test(T3[,4:5], correct = FALSE)
```