...
# Chapter 13
### Correlation Coefficinet ($r$) $Q \rightarrow Q$
...
Here is what the first six rosw of raw data look like:
...
![scatterplot5](./graphics/scatterplot5.gif)
...
![scatterplot6](./graphics/scatterplot6.gif)
![scatterplot7](./graphics/scatterplot7.gif)
![scatterplot8](./graphics/scatterplot8.gif)
...
![scatterplot11](./graphics/scatterplot11.gif)
...
![scatterplot12](./graphics/scatterplot12.gif)
![scatterplot13](./graphics/scatterplot13.gif)
...
![scatterplot14](./graphics/scatterplot14.gif)
...
![linear17](./graphics/linear17.gif)  
...
**Note:** When we square $r$, it tells us what proportion of the variability in one variable is described by variation in the second variable (aka RSquared or Coefficient of Determination).
