...
![linear11](./graphics/linear11.gif)
...
![linear12](./graphics/linear12.gif)
...
$$a = `r MEAN[2]` `r b`\times `r MEAN[1]` = `r coef(summary(mod.lm))[1, 1]`$$
...
Predicted distance = `r coef(summary(mod.lm))[1, 1]` + (`r coef(summary(mod.lm))[2, 1]` * 60) = `r PV`.
